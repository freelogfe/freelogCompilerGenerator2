...
public class AParser extends Parser {
	...
	public static class AbcContext extends ParserRuleContext {
		public TerminalNode A() { return getToken(AParser.A, 0); }
		public TerminalNode AB() { return getToken(AParser.AB, 0); }
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof AListener ) ((AListener)listener).enterAbc(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof AListener ) ((AListener)listener).exitAbc(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof AVisitor ) return ((AVisitor<? extends T>)visitor).visitAbc(this);
